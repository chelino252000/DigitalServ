...
@Composable
fun KeyboardAddScreen(navController: NavController) {
    ...
    Scaffold(
        topBar = {
            CenterAlignedTopAppBar(
                title = { Text("Añadir Teclado", color = Color.White) },
                navigationIcon = {
    ...
    Column(
        ...
        Text(text = "Ingresa los datos del Teclado", fontSize = 16.sp, fontWeight = FontWeight.Bold)
                ...
                if (serialNumber.value.isNotBlank() && name.value.isNotBlank() && brand.value.isNotBlank()) {
                    ...
                    db.collection("Keyboards")
                        ...
                        .addOnSuccessListener {
                            Toast.makeText(context, "Teclado registrado con éxito", Toast.LENGTH_SHORT).show()
