...
@Composable
fun ServerAddScreen (navController: NavController) {
    ...
    Scaffold(
        topBar = {
            CenterAlignedTopAppBar(
                title = { Text("Añadir Servidores", color = Color.White) },
                navigationIcon = {
    ...
    Column(
        ...
        Text(text = "Ingresa los datos del Servidor", fontSize = 16.sp, fontWeight = FontWeight.Bold)
                ...
                if (serialNumber.value.isNotBlank() && name.value.isNotBlank() && brand.value.isNotBlank()) {
                    ...
                    db.collection("server")
                        ...
                        .addOnSuccessListener {
                            Toast.makeText(context, "Servidor registrado con éxito", Toast.LENGTH_SHORT).show()
