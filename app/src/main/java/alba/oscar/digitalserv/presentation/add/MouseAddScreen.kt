...
@Composable
fun MouseAddScreen(navController: NavController) {
    ...
    Scaffold(
        topBar = {
            CenterAlignedTopAppBar(
                title = { Text("Añadir Ratón", color = Color.White) },
                navigationIcon = {
    ...
    Column(
        ...
        Text(text = "Ingresa los datos del ratón", fontSize = 16.sp, fontWeight = FontWeight.Bold)
                ...
                if (serialNumber.value.isNotBlank() && name.value.isNotBlank() && brand.value.isNotBlank()) {
                    ...
                    db.collection("mouse")
                        ...
                        .addOnSuccessListener {
                            Toast.makeText(context, "Ratón registrado con éxito", Toast.LENGTH_SHORT).show()
