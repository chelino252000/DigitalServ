...
fun ServerScreen(navController: NavController) {
    ...
    val server = remember { mutableStateOf<List<Map<String, String>>>(emptyList()) }
        ...
        db.collection("server")
            ...
            .addOnSuccessListener { result ->
                val dataList = result.map { document ->
                    document.data.mapValues { it.value.toString() } // Convertir datos a un mapa de cadenas
                }
                server.value = dataList
            }
    ...
    Scaffold(
        ...
        Box(
                                ...
                                if (index == 4) { // Índice de la columna "Periodicidad"
                                    Text(
                                        ...
                                        modifier = Modifier
                                            .weight(1f)
                                            .clickable {
                                                navController.navigate("serverState_Screen")
                                            },
            ...
            Button(
                onClick = { navController.navigate("server_AddScreen") },
                modifier = Modifier
                    .size(110.dp)
            ...
            Button(
                onClick = { navController.navigate("ServerDelete_Screen") },
                modifier = Modifier
                    .size(110.dp)
            ...
            Button(
                onClick = { navController.navigate("ServerUpdate_Screen") },
                modifier = Modifier
                    .size(110.dp)
