...
@Composable
fun PrinterAddScreen(navController: NavController) {
    ...
    Scaffold(
        topBar = {
            CenterAlignedTopAppBar(
                title = { Text("Añadir Impresora", color = Color.White) },
                navigationIcon = {
    ...
    Column(
        ...
        Text(text = "Ingresa los datos de la Impresora", fontSize = 16.sp, fontWeight = FontWeight.Bold)
                ...
                if (serialNumber.value.isNotBlank() && name.value.isNotBlank() && brand.value.isNotBlank()) {
                    ...
                    db.collection("printer")
                        ...
                        .addOnSuccessListener {
                            Toast.makeText(context, "Impresora registrada con éxito", Toast.LENGTH_SHORT).show()
